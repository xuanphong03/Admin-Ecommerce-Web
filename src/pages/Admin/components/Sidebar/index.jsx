  ...
  return (
    ...
    >
      <div className="flex h-full flex-col gap-2 overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
        <Link className="flex w-full px-5">
          ...
          <ul className="space-y-2 font-medium">
            <li>
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `${isActive ? 'bg-gray-300' : 'hover:bg-gray-200 dark:hover:bg-gray-700'} group flex items-center rounded-lg p-2 text-gray-900 transition-colors dark:text-white`
                }
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Sản phẩm</span>
              </NavLink>
            </li>
            <li>
              <NavLink
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Đơn hàng</span>
              </NavLink>
            </li>
            <li>
              <NavLink
