    ...
    <div>
      ...
      <div className="mt-5 flex w-full flex-col gap-2 text-sm">
        ...
        <div className="flex w-full border border-dotted border-black">
          ...
          <p className="basis-4/5 px-4 py-2">{product.subCategory}</p>
        </div>
        <div className="flex w-full border border-dotted border-black">
          <h3 className="flex basis-1/5 border-r border-dotted border-black p-2 font-medium uppercase">
            Mô tả sản phẩm
        ...
        <div className="flex w-full border border-dotted border-black">
          ...
          <p className="basis-4/5 px-4 py-2">{product.totalQuantity}</p>
        </div>
        <div className="flex w-full border border-dotted border-black">
          <h3 className="flex basis-1/5 border-r border-dotted border-black p-2 font-medium uppercase">
            Ảnh sản phẩm
          ...
          <div className="flex basis-4/5 flex-wrap gap-5 px-4 py-2">
            <div className="flex size-32 items-center justify-center overflow-hidden rounded-lg border border-solid border-black">
              <img className="max-h-full" src={product.imageMain} />
            </div>
