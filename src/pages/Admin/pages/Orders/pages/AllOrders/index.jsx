          ...
          (
            ...
            >
              <div className="flex justify-between py-3 text-sm">
                ...
                <div className="flex basis-[15%] items-center justify-center break-words">
                  {customerAddress}
                </div>
                <div className="flex basis-[10%] items-center justify-center">
                  {orderDate}
                ...
                <div className="flex basis-[10%] items-center justify-center">
                  <select
                    value={orderStatus}
                    onChange={(e) => handleStatusChange(e, orderCode)}
                    name="order_status"
                  >
                ...
                <div className="flex basis-[15%] flex-col items-center justify-center gap-2 text-xs">
                  ...
                  {/* <button className="flex w-1/2 items-center justify-center gap-2 rounded bg-green-600 px-3 py-2 text-[#fafafa] hover:bg-green-500">
                    Cập nhật
                    <FaEdit />
                  </button> */}
                </div>
