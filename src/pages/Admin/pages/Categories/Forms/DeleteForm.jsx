...
function DeleteForm({ category, onDelete, onCancel }) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="text-sm">
        Bạn thật sự muốn xóa loại sản phẩm <i>{category.name}</i> có mã{' '}
        <i>{category.sku}</i>? Nếu bạn đồng ý xóa thì tất cả các sản phẩm liên
        quan đến loại sản phẩm này cũng được xóa theo. Bạn chắc chắn muốn xóa
        chứ?
      </p>
