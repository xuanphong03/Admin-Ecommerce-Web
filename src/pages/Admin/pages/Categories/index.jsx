        ...
        <div className="relative mt-5 overflow-x-auto">
          <table className="w-full text-center text-sm text-gray-500">
            <thead className="bg-gray-50 text-xs uppercase text-gray-700">
              <tr>
                <th className="px-6 py-3 text-center">STT</th>
                <th className="w-1/5 px-6 py-3 text-center">Ảnh minh họa</th>
                <th className="w-1/5 px-6 py-3">Mã loại sản phẩm</th>
                <th className="w-1/5 px-6 py-3">Tên loại sản phẩm</th>
                <th className="w-1/5 px-6 py-3 text-center">
              ...
              {categoriesList.map((category, index) => (
                ...
                >
                  ...
                  <td className="w-1/5 px-6 py-4">
                    <p
                      className={`${
                        category.status === 1 ? 'bg-blue-500' : 'bg-red-500'
                      } mx-auto w-fit rounded px-3 py-1 text-white`}
                    >
                      {category.status === 1
                        ? 'Còn kinh doanh'
                        : 'Ngừng kinh doanh'}
                  ...
                  <td className="flex flex-col items-center gap-1 px-6 py-4 pt-10">
                    <button
                      onClick={() => {
                        setOpenForm(true);
                        setIsUpdating(true);
